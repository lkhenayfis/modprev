...
Alem da previsao pontual, os modelos genuinamente de series temporais (`sarima`, `sarimax`,
`ss_ar1_saz`, `ss_reg_din`) e os modelos periodicos suportam a geracao de trajetorias simuladas
atraves da generica `simulate`:
